...
class EpiModel {
 public:
  ...
  // Jan
  void prepH5(EpiModelParameters &);
  void saveH5(string coreName);
  const EpiData2hd5 *getEpiDataInfo();
 ...
 protected:
  ...
  virtual void summary(int current_day);
...
private:
  //Jan
  void updateTractHistory(int iDay);
  EpiData2hd5 * epiH5=0;
};
